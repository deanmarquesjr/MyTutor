...
public class CSAppointments extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csappointments);
        ...
        btnBackToSub = findViewById(R.id.btnBackToSub);
        txtError = findViewById(R.id.txtCSerror);
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (15 <= hour && hour <= 20 && minute == 0){
                    Intent toConfirm = new Intent(CSAppointments.this, Confirmation.class);
        ...
        btnBackToSub.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent back = new Intent(CSAppointments.this, Subjects.class);
                startActivity(back);
            }
        });
    }
